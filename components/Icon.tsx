...
interface IconProps {
  name: 'github' | 'linkedin' | 'external' | 'code' | 'star' | 'branch' | 'play' | 'briefcase' | 'quote' | 'certificate' | 'mail' | 'phone' | 'whatsapp' | 'terminal' | 'gear' | 'close' | 'chevronDown' | 'layout' | 'server' | 'globe' | 'check' | 'file-text';
  className?: string;
}
