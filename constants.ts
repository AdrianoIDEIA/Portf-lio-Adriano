...
export const CERTIFICATIONS: Certification[] = [
  { name: "Arquitetura de rede", issuer: "Google", date: "dez. 2025", credentialId: "N2MX6F6GGY9X" },
  { name: "Working Effectively with Stakeholders", issuer: "Google", date: "dez. 2025", credentialId: "1OG99THOYL0U" },
  { name: "Introduction to AI", issuer: "Google", date: "dez. 2025", credentialId: "4FYKDXINUDVD" },
  { name: "Start Writing Prompts like a Pro", issuer: "Google", date: "dez. 2025", credentialId: "ZYY91SYG6L0C" },
  { name: "Create a High-Performing Team", issuer: "Google", date: "dez. 2025", credentialId: "XU2M9I0VOW5L" },
  { name: "Introduction to Microsoft Azure Cloud Services", issuer: "Microsoft", date: "dez. 2025", credentialId: "81Y2B6W2LSWY" },
  { name: "Introduction to Artificial Intelligence (AI)", issuer: "IBM", date: "dez. 2025", credentialId: "CUZWJB3TM97L" },
  { name: "AWS Cloud Technical Essentials", issuer: "Amazon Web Services (AWS)", date: "dez. 2025", credentialId: "4Y5JMVEZNZBW" },
  { name: "Python Project for Data Science", issuer: "IBM", date: "dez. 2025", credentialId: "TLMMNBO1N9WD", competencies: "Data Science e Análise de dados" },
  { name: "Introduction to Front-End Development", issuer: "Meta", date: "dez. 2025", credentialId: "Z9HVKP8AD697", competencies: "CSS, JavaScript e mais" },
  { name: "Olá, Python!", issuer: "Google", date: "dez. 2025", credentialId: "4A4PHIFH73LH", competencies: "Data Science, Software Management" },
];